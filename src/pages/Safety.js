    ...
    return (
        <div className="safety-measures">
            <div className="section">
                <h2 className="s">Certified <br /> Equipment</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Professional <br /> Trainers</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Comprehensive <br/> Risk Assessment</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Pre-Camp <br/> Safety<br/> Briefing</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Health and <br/>Medical<br/> Precautions</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Activity-Specific<br/> Safety Measures</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Environmental <br />Safety</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Insurance and<br/> Liability</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Continuous<br/> Monitoring and <br/>Communication</h2>
                <ul>
            ...
            <div className="section">
                <h2 className="s">Post-Activity<br/> Review</h2>
                <ul>
